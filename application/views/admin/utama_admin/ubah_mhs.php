                            ...
                            <form method="post" action="" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="npm" name="npm" class="form-control col-md-7 col-xs-12" value="<?= $mahasiswa['npm']; ?>" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="th_angkatan" name="th_angkatan" class="form-control col-md-7 col-xs-12" value="<?= date("Y", strtotime($mahasiswa['th_angkatan'])); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="nama_mhs" name="nama_mhs" class="form-control col-md-7 col-xs-12" value="<?= $mahasiswa['nama_mhs']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="date" id="tgl_lahir" name="tgl_lahir" class="form-control col-md-7 col-xs-12" value="<?= $mahasiswa['tgl_lahir']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="password" name="password" class="form-control col-md-7 col-xs-12" value="<?= $mahasiswa['password']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fakultas">Fakultas</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="fakultas" name="fakultas" class="form-control col-md-7 col-xs-12" value="<?= $mahasiswa['fak_mhs']; ?>" readonly>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="jurusan">Jurusan</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="jurusan" name="jurusan" class="form-control col-md-7 col-xs-12" value="<?= $mahasiswa['jur_mhs']; ?>" readonly>
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="prodi">Program Studi</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="prodi" name="prodi" class="form-control col-md-7 col-xs-12" value="<?= $mahasiswa['prodi_mhs']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="alamat">Alamat</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea class="form-control" rows="2" name="alamat" id="alamat"><?= $mahasiswa['alamat']; ?></textarea>
                                    </div>
                                </div>
                                <div class="hidden">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="foto">Foto</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="foto" name="foto" value="<?= $mahasiswa['foto_mhs']; ?>" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
